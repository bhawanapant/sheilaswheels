...
import com.esure.motorinsurance.sheilaswheels.domain.enumType.BreakDown;
...
public class BreakdownOptionPage {
    ...
    public void selectBreakdownOptionsAndRecalculateQuote(InsuranceData insuranceData) {
        ...
        waitForQuoteToBeRecalculated(pleaseWaitDialog);
    ...
    private void waitForQuoteToBeRecalculated(WebElement webElement) {
        new WebDriverWait(aDriver,30).until(ExpectedConditions.invisibilityOf(webElement));
    }
}
